...
$mail->CharSet = 'UTF-8';
$mail->setFrom('armis-dveri@yandex.ru'); // от кого будет уходить письмо?
$mail->FromName = 'Краски Armisplus'; // имя отправителя
...
$mail->Body = 'Привет, мир! <p>Это строка <b>HTML кода</b></p> ' . $text;
